    ...
    <div class="justify-center md:px-16">
        <span
          ...
          <a href="https://snapchat.com/add/darkmastermindz" target="_blank" tabindex="7"
            class="f6 grow no-underline br-pill ph3 pv2 mb2 dib text-grey bg-yellow-300 relative inline-flex items-center px-8 py-2 rounded-l-md border">Snapchat</a>
          ...
          <a href="https://hansel.rocks" target="_blank" 
            class="f6 grow no-underline br-pill ph3 pv2 mb2 dib text-white bg-red relative inline-flex items-center px-8 py-2 rounded-l-md border">Instagram</a>
          ...
          <a href="https://linkedin.com/in/hanselwei" target="_blank" tabindex="11"
            class="f6 grow no-underline br-pill ph3 pv2 mb2 dib text-white bg-blue-700 relative inline-flex items-center px-8 py-2 rounded-l-md border">Linkedin</a>
          ...
          <a href="https://hansel.run/connect" target="_blank" tabindex="12"
            class="visible md:invisible f6 grow no-underline br-pill ph3 pv2 mb2 dib text-white bg-green-300 relative inline-flex items-center px-4 py-2 rounded-l-md border">💾 Save to Contacts</a>
        </span>
    </div>
</template>
